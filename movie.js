...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=f436d762d29a270acf236619217be1ce&language=en-US&page=1')
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=f436d762d29a270acf236619217be1ce&language=en-US&page=2')
.then(response => response.json())
.then(data =>{
    data.results.map((i, j) => {
        if(j > 18)
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=f436d762d29a270acf236619217be1ce&language=en-US&page=3')
.then(response => response.json())
.then(data =>{
    data.results.map((i, j) => {
        if(j > 18)
